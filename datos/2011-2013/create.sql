CREATE TABLE "anexo1-numero-de-oficiales-federales-de-pesca" (
...
CREATE TABLE "anexo3-numero-embarcaciones" (
...
CREATE TABLE "anexo4-recorridos-inspeccion" (
...
CREATE TABLE "anexo5-total-de-actas-y-verificaciones-documentales" (
...
CREATE TABLE "anexo6-arte-de-pesca-retenidas-provisionalmente" (
	"Entidad Federativa" VARCHAR(19) NOT NULL, 
...
CREATE TABLE "anexo6-embarcaciones-retenidas-provisionalmente" (
	"Entidad Federativa" VARCHAR(19) NOT NULL, 
...
CREATE TABLE "anexo6-vehiculos-retenidas-provisionalmente" (
	"Entidad Federativa" VARCHAR(19) NOT NULL, 
	"2009" VARCHAR(2) NOT NULL, 
	"2010" VARCHAR(2) NOT NULL, 
	"2011" VARCHAR(3) NOT NULL, 
...
CREATE TABLE "anexo7-pesca-ilegal-2013" (
	"Año" INTEGER, 
	"ESTADO" VARCHAR(19), 
	"ABULON" FLOAT, 
...
CREATE TABLE "anexo7-pesca-ilegal" (
	"Año" INTEGER NOT NULL, 
	"ESTADO" VARCHAR(19) NOT NULL, 
	"ABULON" FLOAT, 
...
CREATE TABLE "anexo8-listado-denuncias-2011-2013" (
	"Año" INTEGER NOT NULL, 
	"Estado" VARCHAR(19) NOT NULL, 
