...
CREATE TABLE "20082013motores" (
	"Año,Beneficiario,RNPA,Estado,Municipio,Localidad,Monto_federal,Monto_estatal" VARCHAR(18) NOT NULL
);
CREATE TABLE "20112012pesca" (
	"Año" INTEGER NOT NULL, 
	"Beneficiario" VARCHAR(165), 
...
CREATE TABLE "20112013diesel" (
	"Año" INTEGER NOT NULL, 
	"Beneficiario" VARCHAR(87) NOT NULL, 
	"CURP" VARCHAR(12), 
	"RFC" VARCHAR(13), 
	"RNPA" BIGINT, 
	"Localidad" VARCHAR(36) NOT NULL, 
...
CREATE TABLE "20112013motorescomponentes" (
	"Componente,""Año"",""Beneficiario"",""RNPA"",""Estado"",""Municipio"",""Localidad"",""Monto_federal"",""Monto_estatal""" VARCHAR(31) NOT NULL
);
CREATE TABLE "2011electricos" (
	"Año" INTEGER NOT NULL, 
	"Beneficiario" VARCHAR(37) NOT NULL, 
