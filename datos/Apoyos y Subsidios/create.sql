...
CREATE TABLE "20082013motores" (
	"Año,Beneficiario,RNPA,Estado,Municipio,Localidad,Monto_federal,Monto_estatal" VARCHAR(17) NOT NULL
);
CREATE TABLE "20112012pesca" (
	"Año" INTEGER NOT NULL, 
	"Beneficiario" VARCHAR(165), 
...
CREATE TABLE "20112013diesel" (
	"Año" INTEGER NOT NULL, 
	"NOMBRE" VARCHAR(32), 
	"PRIMER APELLIDO" VARCHAR(32), 
	"SEGUNDO APELLIDO" VARCHAR(32), 
	"RAZON SOCIAL" VARCHAR(87), 
	"CURP" VARCHAR(205), 
	"RFC" VARCHAR(205), 
	"RNPA" BIGINT, 
...
CREATE TABLE "20112013motorescomponentes" (
	"Componente,Año,Beneficiario,RNPA,Estado,Municipio,Localidad,Monto_federal,Monto_estatal" VARCHAR(22) NOT NULL
);
CREATE TABLE "2011electricos" (
	"Año" INTEGER NOT NULL, 
	"Beneficiario" VARCHAR(37) NOT NULL, 
